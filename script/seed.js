...
async function seed() {
  ...
  const stretches = await Promise.all([
    Stretch.create({
      ...
      category: ["shoulders"],
      imageURL:
        "https://vp.nyt.com/video/2020/05/12/86478_1_00sl-ergonomic-shrug_wg_720p.mp4",
    }),
    Stretch.create({
      ...
      imageURL:
        "https://vp.nyt.com/video/2020/05/12/86481_1_00sl-ergonomics-shoulder_wg_720p.mp4",
    }),
    Stretch.create({
      ...
      category: ["lower-back"],
      imageURL:
        "https://assets.bupa.co.uk/~/media/images/healthmanagement/blogs/desk-stretches-2020/seated-spinal-rotation-600-600.jpg",
    }),
